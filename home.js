...
export default function Home() {
    ...
    const [addTask, { data, error, isLoading, isSuccess, isError, reset }] = useAddTaskMutation();
    const [updateTask,{ data: tasksList, isError, isLoading, error}] = useUpdateTaskMutation();
    const [deleteTask,{ data: tasksList, isError, isLoading, error}] = useDeleteTaskMutation();
